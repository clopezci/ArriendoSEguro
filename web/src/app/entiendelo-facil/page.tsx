  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900 text-slate-100">
      <main className="mx-auto max-w-6xl space-y-8 px-4 py-10 sm:px-6">
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 shadow-[0_14px_34px_rgba(139,92,246,0.22)]">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link
              href="#encuesta"
              className="rounded-lg border border-violet-500 px-5 py-2.5 text-sm font-medium text-violet-200 shadow-[0_0_14px_rgba(139,92,246,0.35)] hover:bg-violet-900/30"
            >
              Responder encuesta
            </Link>
          </div>
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/65 p-6 shadow-[0_10px_24px_rgba(139,92,246,0.18)]">
          ...
          <ul className="mt-4 grid gap-2 sm:grid-cols-2">
            {problemPoints.map((item) => (
              <li key={item} className="rounded-lg border border-slate-800 bg-slate-900/70 px-3 py-2 text-sm">
                {item}
              </li>
            ))}
          </ul>
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/65 p-6 shadow-[0_10px_24px_rgba(139,92,246,0.18)]">
          ...
          <p className="mt-4 rounded-lg border border-violet-500/50 bg-violet-900/20 px-4 py-3 text-violet-200">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/65 p-6 shadow-[0_10px_24px_rgba(139,92,246,0.18)]">
          ...
          <ol className="mt-4 grid gap-2 sm:grid-cols-2">
            {steps.map((step, i) => (
              <li key={step} className="rounded-lg border border-slate-800 bg-slate-900/70 px-3 py-2 text-sm">
                <span className="font-semibold text-violet-300">{i + 1}.</span> {step}
              </li>
            ))}
          </ol>
        </section>
        ...
        <section id="encuesta" className="rounded-2xl border border-slate-800 bg-slate-900/75 p-6 shadow-[0_12px_30px_rgba(139,92,246,0.22)]">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/75 p-6 text-center shadow-[0_14px_34px_rgba(139,92,246,0.22)]">
