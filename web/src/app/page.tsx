  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900 text-slate-100">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          ...
          <div className="flex items-center justify-end gap-2 sm:gap-3">
            <Link
              ...
              className="shrink-0 rounded-lg border border-violet-500 px-3 py-1.5 text-sm font-medium text-violet-200 shadow-[0_0_14px_rgba(139,92,246,0.35)] transition hover:bg-violet-900/30 sm:px-4"
            >
              ¿Primera vez arrendando?
            </Link>
            <Link
              href="/ingresar"
              className="shrink-0 rounded-lg border border-slate-700 px-3 py-1.5 text-sm font-medium text-slate-100 shadow-[0_0_0_1px_rgba(139,92,246,0.28)] transition hover:border-slate-500 sm:px-4"
            >
              Ingresar
            </Link>
            <Link
      ...
      <main className="mx-auto max-w-6xl space-y-8 px-4 py-8 sm:space-y-10 sm:px-6 sm:py-10">
        <section className="space-y-5 rounded-2xl border border-slate-800 bg-slate-900/70 p-6 shadow-[0_14px_34px_rgba(139,92,246,0.2)] sm:p-10">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-[0_10px_24px_rgba(139,92,246,0.18)] sm:p-6">
          ...
          <ul className="mt-4 grid gap-2 text-sm text-slate-200 sm:grid-cols-2">
            ...
            <li className="rounded-lg border border-slate-800 bg-slate-950/40 px-3 py-2 sm:col-span-2">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-[0_10px_24px_rgba(139,92,246,0.18)] sm:p-6">
          ...
          <ul className="mt-4 grid gap-2 text-sm text-slate-200 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <li className="rounded-lg border border-slate-800 bg-slate-950/40 px-3 py-2 sm:col-span-2 lg:col-span-3">
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-[0_10px_24px_rgba(139,92,246,0.18)]">
              <h3 className="text-lg font-semibold text-sky-300">Inmobiliaria</h3>
            ...
            <article className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-[0_10px_24px_rgba(139,92,246,0.18)]">
              <h3 className="text-lg font-semibold text-sky-300">Informal</h3>
              <p className="mt-2 text-sm leading-relaxed text-slate-300">
                Más rápido y barato al inicio, pero con menos soportes si aparece un problema.
              </p>
            </article>
            <article className="rounded-2xl border border-violet-500/50 bg-slate-900/70 p-5 shadow-[0_10px_26px_rgba(139,92,246,0.25)]">
              <h3 className="text-lg font-semibold text-violet-300">Arriendo Seguro</h3>
        ...
        <section
          id="interes"
          className="scroll-mt-8 rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-[0_10px_24px_rgba(139,92,246,0.18)] sm:p-6"
        >
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-slate-800 bg-slate-900/65 p-4 shadow-[0_10px_24px_rgba(139,92,246,0.18)]">
              ...
              <p className="mt-1 text-violet-300">Gratis</p>
            ...
            <article className="rounded-2xl border border-violet-500/40 bg-slate-900/70 p-4 shadow-[0_10px_24px_rgba(139,92,246,0.25)]">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 shadow-[0_10px_24px_rgba(139,92,246,0.18)] sm:p-6">
          <h2 className="text-xl font-semibold sm:text-2xl">
            Lo que Arriendo Seguro no hace
          </h2>
          <p className="mt-2 max-w-5xl text-slate-300">
        ...
        <section className="rounded-2xl border border-violet-500/40 bg-slate-900/70 p-6 text-center shadow-[0_14px_34px_rgba(139,92,246,0.2)]">
