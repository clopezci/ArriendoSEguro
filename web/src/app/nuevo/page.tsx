    ...
    case "registry":
      return (
        <div className="flex flex-col gap-3">
          ...
          <PropertyDocUpload contractDraftId={party.draftId} docType={a.propertyDocType} onDocType={(v) => setA({ ...a, propertyDocType: v })} expectedName={a.acting === "proxy" ? a.poderdanteName : a.name} expectedAddress={a.address} actingAs={a.acting} />
