            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {ACTIONS.filter((a) => a.phase === phase).map((a, idx) => (
                <motion.button
                  ...
                  onClick={() => router.push(a.slug === "inventory" ? `/nuevo/gestionar/${id}/inventario` : a.slug === "inventory-final" ? `/nuevo/gestionar/${id}/inventario?kind=final` : a.slug === "aliados" ? `/nuevo/gestionar/${id}/aliados` : `/dashboard/contracts/${id}/${a.slug}`)}
