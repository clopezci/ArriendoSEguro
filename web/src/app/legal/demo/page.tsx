  ...
  return (
    <article className="space-y-8 text-sm leading-relaxed text-slate-300">
      <header className="space-y-2 border-b border-slate-800 pb-6">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">Condiciones del modo demo</h1>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-white">1. Demo sin validez legal</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-white">2. Documentos con marca de agua</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-white">3. Datos ficticios</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-white">4. No firma real</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-white">5. No contrato real</h2>
        <p>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-white">6. No uso probatorio</h2>
        <p>
