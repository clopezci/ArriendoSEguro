    ...
    <article className="space-y-8 text-sm leading-relaxed text-slate-700">
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          visibilidad que {appConfig.name} publique. No hay perfil público de reputación salvo que se indique
      ...
      <section className="space-y-3">
        ...
        <p>
          No habrá un buscador público que permita localizar historiales ingresando el número
