...
| **Modelo gratis/pago** | Hecho: crear gratis, watermark+CTA (con % del valor), gate de firma y posventa (novedades/alertas/soportes/evidencia/pagos/inventario), PDF de descarga marcado (contrato guardado limpio). Falta: copy gratis en **landing/entiéndelo**, revisar **demo** |
